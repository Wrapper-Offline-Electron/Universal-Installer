...
curl -f https://github.com/Wrapper-Offline-Electron/Universal-Installer/releases/download/v0.1.1/WOE-Universal-Installer-darwin-amd64 -o ~/Desktop/WOE-Universal-Installer && echo "Successfully installed." || echo "Failed to install with curl."
